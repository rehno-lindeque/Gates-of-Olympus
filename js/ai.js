...
floodFill = function(goal, lev) {
  var Q, _a, _b, _c, f, index, j, l, pos, shortestThroughNode, x, y;
  Q = new Array();
  f = 0;
  l = 1;
  Q[f] = goal;
...
floodFillGenPath = function(start, lev) {
  var _a, cur, goal, index, j, shortest, shortestIndex, x, y;
  cur = start;
  goal = levelGoals[lev];
  shortest = Infinity;
  shortestIndex = -1;
...
updateAI = function() {
  var _a, _b, _c, _d, creature, index, lev;
  floodInit();
  ...
  _d = [];
  for (i = 0; i <= 2; i++) {
    _d.push(dirtyLevel[i] = false);
  }
  return _d;
};
towerIsBlocking = function(index) {
  var _a, _b, _c, c, startIndex, towerLevel;
